...
echo use_javascript(plugin_web_path('extras', 'dragtable/js/jquery.dragtable.js'));
echo use_javascript(plugin_web_path('extras', 'jquery.tablednd.js'));

echo use_stylesheet(plugin_web_path('extras', 'dragtable/css/dragtable-default.css'));
...
<script>
    ...
    $(document).ready(function(){
        ...
        jQuery('#resultTable').each(function(){
